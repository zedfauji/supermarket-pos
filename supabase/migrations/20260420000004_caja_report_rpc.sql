-- ============================================================================
-- CAJA REPORT RPC
-- Returns aggregate report data for a given caja session.
-- Called by the Reports page.
-- ============================================================================
...
-- List all caja sessions (for reports date navigation)
CREATE OR REPLACE FUNCTION list_caja_sessions(p_limit INT DEFAULT 30)
RETURNS JSON
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
