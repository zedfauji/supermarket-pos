...
- gap_id: G-27-8
  ...
  status: deferred
  deferred_to: "Phase 28: Promotion Management Redesign"
  deferred_reason: "Part A (the uneditable percent-field bug) was a narrow bug and was fixed as a Phase 27 gap plan (27-10-PLAN.md). Part B (multi-select/blank-promotion/recurrence/wizard) is a genuine feature/design expansion — five gap-closure plans (27-11 through 27-15) were initially drafted for it but withdrawn (never executed) after the user flagged that this scope skipped discuss-phase/ui-phase/research entirely. It is now Phase 28, to be planned properly via /gsd-discuss-phase 28 + /gsd-ui-phase 28 before any code plan is written. The root-cause characterization below remains accurate and is the starting point for that phase's research, not a substitute for it."
